...
type FlightTableRowProps = {
  flightData: Flight;
  onProceedClick: (data: Flight) => void;
}

const FlightTableRowAgent: React.FC<FlightTableRowProps> = ({ flightData, onProceedClick }) => {
  return (
    <tr className="hover:bg-gray-50">
      ...
      <td className="px-6 py-4">
        <div className="flex justify-end gap-4">
          <div className='p-2 rounded-full hover:bg-gray-200' onClick={() => onProceedClick(flightData)}>
            <img src='/arrow-right.svg' className='h-6 w-6' />
          </div>
        </div>
      </td>
    </tr>
...
export default FlightTableRowAgent;